export const events = [
  {
    ...
    description:
      "Working alongside my sister to start freelancing web development. I primarily work on the development of the website and offer unique scroll animations and custom 3D models to be implemented into your website.",
    date: "Jan 2025 - Present",
    direction: "right",
    image: "./jeffrey-logo.png",
  },
  {
    heading: "MHSS Computer Science Club",
    subHeading: "President",
    description:
      "Equipping Maxwell with real-world applicable computer science skills for all skill levels. I lead a team of executives to teach web development, competitive programming, and data structures. The club has reached 80+ members at Maxwell, demonstrating the eagerness of the community to start learning computer science.",
